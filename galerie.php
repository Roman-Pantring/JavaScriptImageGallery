...
if ($handle = opendir($folder)) {
    ...
    while (false !== ($entry = readdir($handle))) {
        if($entry != "." && $entry != ".." && $entry!='thumbs' && $entry !='My Actions.atn'){
		
		if(file_exists($file)){
			//echo('V1'); Windows
			$imgstr .= utf8_encode("'$entry',");
			}else{
			//echo('V2'); Linux
			$imgstr .= ("'$entry',");			
		}
...
removeBoxes = function(e){
		...
		//alert(document.body.childNodes[13].id);
		//alert(document.body.childNodes[14].id);
		setTimeout(function(){
			/*document.body.removeChild(document.body.childNodes[13]);
			document.body.removeChild(document.body.childNodes[13]); */
...
function galerieImages(a){	
	var galerieBox = document.getElementById("galerie");
	/* 'Chrysanthemum.jpg','Desert.jpg','Hydrangeas.jpg','Jellyfish.jpg','Koala.jpg','Lighthouse.jpg','Penguins.jpg','Tulips.jpg','2014-06-21.jpg','2014-06-22.jpg','2014-06-23.jpg','2014-06-24.jpg','2014-06-25.jpg','2014-06-26.jpg','2014-06-27.jpg','2014-06-28.jpg','2014-06-29.jpg' */
	galerie =  {images:[<?php echo($imgstr); ?>],lineCount:a};
	galerie.lines = Math.ceil(galerie.images.length/galerie.lineCount);
